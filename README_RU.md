...
Проект является глубокой переработкой [WEASEL][facebook-weasel].

Использование такого вида трекинга незаконно, потому этот проект - просто техническая демка, которая не использовалась ИНВИАНом.
Тем не менее, наличие такого репозитория в гитхабе компании помогает внушать страх в сердца тех, кто считает, что может
стащить проприетарный код или ML модели честных компаний и им ничего за это не будет.
...
Потенциально при правильной доработке, может стать контрольным центром для RCE. Но нам это было не надо. Реализацию такого механизма можно посмотреть здесь: [WEASEL][facebook-weasel].
